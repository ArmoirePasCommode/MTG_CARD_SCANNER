...
const AuthScreen = (): React.JSX.Element => {
  ...
  return (
    <LinearGradient colors={['#0f0a1f', '#1a103a', '#0f0a1f']} style={styles.gradient}>
      <KeyboardAvoidingView
        style={styles.flex}
      ...
      >
        ...
        >
          <View style={styles.brand}>
            ...
            <Text style={styles.brandSubtitle}>Scan, organize, and master your collection</Text>
          </View>
          ...
          <Animated.View style={[styles.card, { opacity: fade }]}>
            ...
            <Pressable onPress={switchMode} style={styles.switchButton}>
              <Text style={styles.switchButtonText}>
                ...
                <Text style={styles.switchButtonLink}>{isLogin ? 'Sign up' : 'Log in'}</Text>
              </Text>
            </Pressable>
          </Animated.View>
...
const styles = StyleSheet.create({
  ...
  brandTitle: { fontSize: 24, fontWeight: '700', color: '#fff', letterSpacing: 0.3 },
  brandSubtitle: { fontSize: 14, color: '#9ca3af', marginTop: 6, textAlign: 'center' },
  card: {
  ...
  heading: { fontSize: 22, fontWeight: '700', color: '#fff', marginBottom: 6 },
  ...
  primaryButton: { borderRadius: 14, overflow: 'hidden', marginTop: 6 },
  ...
  switchButtonLink: { color: '#a78bfa', fontWeight: '600' },
  footer: { color: '#6b7280', fontSize: 11, textAlign: 'center', marginTop: 24 },
});
