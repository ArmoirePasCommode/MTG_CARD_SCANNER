...
const ProfileScreen = () => {
  ...
  const stats = useMemo(() => {
    ...
    return [
      { icon: 'albums-outline', label: 'Total cards', value: cards.length, accent: colors.primaryAccent },
      { icon: 'flame-outline', label: 'Mythics', value: byRarity.mythic || 0, accent: '#f97316' },
      { icon: 'star-outline', label: 'Rares', value: byRarity.rare || 0, accent: '#fbbf24' },
      { icon: 'sparkles-outline', label: 'Uncommons', value: byRarity.uncommon || 0, accent: '#94a3b8' },
    ];
  }, [cards]);
        ...
        >
          ...
          <View style={styles.profileCard}>
            ...
            <Text style={styles.displayName}>
              {user?.displayName || 'Unknown planeswalker'}
            </Text>
