...
const sortLabel = (id) =>
  SORT_OPTIONS.find((s) => s.id === id)?.label ?? 'Recent';
...
const CollectionToolbar = ({
  ...
  const activeCount =
    filters.rarities.size + filters.colors.size + (filters.foilOnly ? 1 : 0);
      ...
      >
            ...
            >
              <Text
                style={[
                  ...
                  { color: active ? c.textColor : colors.textMuted },
                ]}
              >
                {c.label}
              </Text>
        ...
        >
          ...
          <Text
            style={[
              styles.chipText,
              filters.foilOnly && styles.chipTextActive,
            ]}
          >
            Foil only
          </Text>
