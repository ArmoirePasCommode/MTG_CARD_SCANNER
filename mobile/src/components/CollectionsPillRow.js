...
const CollectionsPillRow = () => {
  ...
  const [renameModalTag, setRenameModalTag] = useState(null);
            ...
            Alert.alert(
              ...
              [
                { text: 'Cancel', style: 'cancel' },
                {
                  text: 'Delete',
                  style: 'destructive',
                  onPress: () => deleteTagEverywhere(tag.name),
                },
              ]
            );
          },
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        >
          <Text style={[styles.pillText, activeTag === null && styles.pillTextActive]}>
            All
          </Text>
          ...
          return (
            ...
            >
              <Text
                style={[
                  styles.pillText,
                  isActive && { color: c.fg, fontWeight: '700' },
                ]}
                numberOfLines={1}
              >
                {tag.name}
              ...
              <View style={[styles.badge, isActive && { backgroundColor: c.border }]}>
                <Text style={[styles.badgeText, isActive && { color: c.fg }]}>
                  {tag.count}
                </Text>
              </View>
            </Pressable>
