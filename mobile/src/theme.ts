...
export const gradients = {
  background: ['#0f0a1f', '#1a103a', '#0f0a1f'] as const,
 ...
 */
export const rarityColors: Record<string, RarityColor> = {
...
export const getRarityColor = (rarity: string | null | undefined): RarityColor => {
